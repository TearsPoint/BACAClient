...
namespace Base.MyXls
{
    internal class Record
    {
        ...
        {
            _rid = Base.MyXls.RID.ByteArray(rid);
            int offset = 0;
        ...
        public static List<Record> GetAll(Bytes stream)
        {
            ...
            {
                byte[] rid = Base.MyXls.RID.ByteArray(stream.Get(i, 2).ByteArray);
...
namespace Base.MyXls
{
    ...
    public class XlsDocument
    {
        ...
        /// <summary>
        /// Gets this Base.MyXls XlsDocument's OLE2 Document.
        /// </summary>
        public Ole2Document OLEDoc { get { return _ole2Doc; } }

        /// <summary>
        /// Gets this Base.MyXls XlsDocument's Workbook.
        /// </summary>
...
namespace Core.MyOle2.Metadata
{
    ...
    public class SummaryInformationSection : MetadataStream.Section
    {
        ...
        public SummaryInformationSection()
        {
            ...
            NameOfCreatingApplication = "Base.MyXls";
